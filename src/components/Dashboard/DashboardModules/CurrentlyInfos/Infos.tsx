  ...
  return (
    <S.Container>
      ...
      <S.Infos style={{"marginTop":".7rem"}}>
        <S.CurrentInfo>
          <h1 style={{"color":"#FF3AF9"}}>{valueFormatter.format(values.incoming)}</h1>
          <span>This month's incomings</span>
        </S.CurrentInfo>
        <S.CurrentInfo>
          <h1 style={{"color":"#CE49E6"}}>{valueFormatter.format(values.expenses)}</h1>
          <span>This month's expenses</span>
        </S.CurrentInfo>
        <S.CurrentInfo>
          <h1 style={{"color":"#7A4CB3"}}>{valueFormatter.format(values.incoming - values.expenses)}</h1>
